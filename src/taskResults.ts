...
const createHtml = (issuesTable: string, eventsTable: string, shameTable: string, numberOfEvents: number) => `
  <html>
    <head>
      <style>
        table {
    ...
    <body>
        <center>
            ...
            ${eventsTable}
            <br>
            <font size="+1"><b>Number of dangeorus events: ${numberOfEvents}</b></font><br>
        </center>
        <br>
...
class TaskResults {
    ...
    generateHTMLReport() {
        ...
        const htmlReport = createHtml(issueTable, eventTable, shameTable, this.closeCalls.length)
